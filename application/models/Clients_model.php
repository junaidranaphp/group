...
class Clients_model extends CI_Model {
    ...
    public function get_sorting_cleints($limit, $start, $sort_field, $sort_order) {
        return $this->db->limit($limit, $start)->order_by($sort_field, $sort_order)->get('usuarios')->result();
    }
