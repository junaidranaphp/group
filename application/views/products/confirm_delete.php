<div class="row">
    <div class="col-sm-12">
        ...
        <div class="box box-color box-bordered">
            ...
            <div class="box-title">
                <h3><?php echo LTEXT('_delete_product') ?></h3>
            </div>
            ...
            <div class="box-content ">
                <table class="table table-hover table-nomargin table-condensed table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo $product->Prod_Grp; ?></td>
                            <td><?php echo $product->Rim; ?></td>
                            <td><?php echo $product->Pattern_Family; ?></td>
                            <td><?php echo $product->Speed; ?></td>
                            <td><?php echo $product->Type; ?></td>
                            <td><?php echo $product->Tubed_Tubeless; ?></td>
                            <td><?php echo $product->Stock; ?></td>
                            <td><?php echo $product->Source; ?></td>
                            <td><?php echo $product->CCT_Price_FOB_2004_Rounded; ?></td>
                ...
                <form method="post">
                    ...
                    <div class="text text-danger text-center">
                        ...
                        <input type="hidden" name="id" value="<?php echo $product->master_product_file_id?>"/>
