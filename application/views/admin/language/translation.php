				...
				<div class="row">
					<div class="col-sm-12">
						<?php echo form_open('',array('class'=>'form-horizontal'))?>
							...
							<div class="form-group">
								<label for="de" class="control-label col-sm-2"><?php echo LTEXT('_fr')?></label>
								<div class="col-sm-10">
									<input value="<?php echo set_value('de',$translation ? $translation->fr: '')?>" type="text" id="de" name="de" class="form-control"/>
								</div>
							</div>
							<div class="form-group">
								<label for="de" class="control-label col-sm-2"><?php echo LTEXT('_pt')?></label>
								<div class="col-sm-10">
									<input value="<?php echo set_value('de',$translation ? $translation->pt: '')?>" type="text" id="de" name="de" class="form-control"/>
								</div>
							</div>
							<div class="form-group">
