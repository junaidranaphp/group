    ...
    <div class="col-sm-12">
        <div class="box box-color box-bordered">
            ...
            <div class="box-content nopadding">
                <?php echo form_open(base_url('admin/products/delete_products')) ?>
                <table class="table table-condensed table-hover table-nomargin table-bordered">
                    <thead>
                        <tr>
                            <th>&nbsp;</th>
                            ...
                            <tr>
                                <td>
                                    <div class="action-group">
                                        <a
                                            href="<?php echo base_url('admin/products/edit_product/' . $row->master_product_file_id) ?>"
                                            class="btn edit-additional-contact"> <i class="fa fa-edit"></i>
                                        </a> <a href="<?php echo base_url('admin/products/delete_products/' . $row->master_product_file_id) ?>" class="btn remove-additional-contact"> <i
                                                class="fa fa-times"></i>
                                        </a>
                                    </div>
                                </td>
...
<script>
    ...
    $(document).ready(function () {
        $('#mytabless').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo base_url('products/records')?>",
        });
    });
</script>
