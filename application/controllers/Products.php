...
class Products extends BASIC_Controller {
    ...
    public function records(){
        ...
        $result = $this->datatables->select('master_product_file.Code,Prod_Grp,Rim,Pattern_Family,Type,Tubed_Tubeless,Stock,Source,CCT_Price_FOB_2004_Rounded,Net_Price')
                ->from('permisos')
